...
namespace GremlinNetSample
{
    ...
    class Program
    {
        ...
        private static string hostname = "graphtest134.gremlin.cosmosdb.azure.com";
        private static int port = 443;
        private static string authKey = "B1TYvNNg6vi4tXZgJKG1ydNI2QgyoIoHvZq8JX2iwGvyIXTxJgu8JgL3lihxGAvSFg3IXwdrJuoAc8hxzP1tIw==";
        ...
        private static Dictionary<string, string> gremlinQueries = new Dictionary<string, string>
        {
            ...
            { "AddVertex 5",    "g.addV('person').property('id', 'nicky').property('firstName', 'Nicky').property('age', 44)" },
            { "AddVertex 6",    "g.addV('person').property('id', 'george').property('firstName', 'George').property('lastName', 'Andersen').property('age', 39)" },
            { "AddVertex 7",    "g.addV('person').property('id', 'kim').property('firstName', 'Kim').property('lastName', 'Miller')" },
            { "AddVertex 8",    "g.addV('person').property('id', 'alex').property('firstName', 'Alex').property('lastName', 'Wakefield')" },
            { "AddEdge 1",      "g.V('thomas').addE('Colleague').to(g.V('mary'))" },
            { "AddEdge 2",      "g.V('thomas').addE('Colleague').to(g.V('ben'))" },
            { "AddEdge 3",      "g.V('ben').addE('Colleague').to(g.V('robin'))" },
            { "AddEdge 4",      "g.V('George').addE('Colleague').to(g.V('ben'))" },
            { "AddEdge 5",      "g.V('ben').addE('Husband').to(g.V('nicky'))" },
            { "AddEdge 6",      "g.V('nicky').addE('mother').to(g.V('alex'))" }
